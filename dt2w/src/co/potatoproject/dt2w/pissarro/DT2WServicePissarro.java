...
public class DT2WServicePissarro extends Service {
    private static final String TAG = "DT2WServicePissarro";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.pissarro.dt2w", dt2wEnabled ? "1" : "0");
        }
