...
static const variant_info_t pissarroin_info = {
    ...
    .device = "pissarroin",
    .model = "Xiaomi 11i",
    .build_fingerprint = "Xiaomi/pissarroin/pissarroin:12/SP1A.210812.016/V816.0.2.0.TKTMIXM:user/release-keys",
};
...
static const variant_info_t pissarroinpro_info = {
    ...
    .build_fingerprint = "Xiaomi/pissarroinpro/pissarroinpro:12/SP1A.210812.016/V816.0.2.0.TKTMIXM:user/release-keys",
};
...
static const variant_info_t pissarroprocn_info = {
    ...
    .device = "pissarropro",
    .model = "Redmi Note 11 Pro+",
    .build_fingerprint = "Redmi/pissarropro/pissarropro:12/SP1A.210812.016/V816.0.2.0.TKTMIXM:user/release-keys",
};
...
static const variant_info_t pissarroprods_info = {
    ...
    .build_fingerprint = "Redmi/pissarropro_global/pissarropro:12/SP1A.210812.016/V816.0.2.0.TKTMIXM:user/release-keys",
};
